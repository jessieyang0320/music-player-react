...
class Player extends Component {
	constructor(props) {
        super(props);
        this.state = {
            index: Math.floor(Math.random() * 10), // randomly play one in 10
            playing: false,
            value: '',
            rangeStyle: null,
            loaded: false
	...
	render(){
		...
		return(
			<div className="components-box">
                    <p className="links">
                        <Link to={{pathname:"/list",state:{songlist:this.state.song_list,currentIndex:currentIndex}}}>My Music</Link>
                    </p>
                    ...
                    <Route path='/:id' component={MusicList}/>
                </div>
            )
        } else {
            return (
